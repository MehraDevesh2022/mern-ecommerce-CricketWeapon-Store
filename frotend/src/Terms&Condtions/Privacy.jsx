  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          Send you promotional offers, newsletters, and marketing communications
      ...
      <ul>
        ...
        <li>
          To comply with legal obligations, enforce our policies, or respond to
          legal requests
        </li>
        <li>
      ...
      <p>
        ...
        posted on this page, and the revised Privacy Policy will take effect
        immediately upon posting. We encourage you to review this Privacy Policy
