...
- Step 1: Prepare Your Project - Organize your project with a root directory that contains both frontend and backend folders. - Ensure both backend and frontend directories have all necessary code and dependencies. - Create a `vercel.json` file in the root directory. - Add the following code to `vercel.json`:
      ...
      "rewrites": [
         ...
         ### Note :
          ...
          - Also folder structre should be like this
          ```
          root
          |__backend
          |__frontend
          ...
          |__vercel.json
          ```
   -Step 2 : Push all your code to github ignore node_modules folder and .env file
    -Step 3 : Create a account on vercel and connect your github account
    -Step 4 : Create a new project and select your github repo CricketWeapon-store in my case
    -Step 5 : with Configure Project levae all the settings as it is and just add your all .env variables in Environment Variables section only
    -Step 6 : Click on Deploy and wait for few minutes and your app will be deployed
    -Step 7 : Click on Visit and your app will be live
